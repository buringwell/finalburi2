...
Route::middleware('auth:api')->group(function () {
    ...
    Route::prefix('pelanggan')->middleware('api')->group(function () {
    ...
    //pelanggandetail
    Route::prefix('pelanggan-d')->middleware('api')->group(function (){
    ...
    Route::prefix('penyewaan-detail')->group(function () {
